...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/demo/demoTest/">测试数据列表</a></li>
		<li class="active"><a href="${ctx}/demo/demoTest/form?id=${demoTest.id}">测试数据<shiro:hasPermission name="demo:demoTest:edit">${not empty demoTest.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="demo:demoTest:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
